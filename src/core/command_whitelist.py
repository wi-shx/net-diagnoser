    ...
    DEFAULT_WHITELIST: List[WhitelistedCommand] = [
        ...
        WhitelistedCommand(
            ...
            allowed_args=[
                ...
                "-4", "-6", "-0", "-d", "-r", "-n", "-b", "-c", "-v", "-s", "-h",
                "-o", "-t", "-rc", "-oneline", "-details", "-statistics", "-human",
            ],
            risk_level="low",
            allowed_patterns=[
                r"-4", r"-6", r"-0",
                r"addr\s+show", r"link\s+show", r"route\s+show",
                r"maddr\s+show", r"neigh\s+show",
            ],
        ),
        WhitelistedCommand(
            command="ifconfig",
        ...
        WhitelistedCommand(
            ...
            description="PCI设备列表",
            category="hardware",
            allowed_args=["-v", "-vv", "-n", "-nn", "-k", "-s"],
            risk_level="low",
            allowed_patterns=[r"-s\s+[\da-fA-F:.]+", r"-v+", r"-nn"],
        ),
        WhitelistedCommand(
            command="lshw",
            description="硬件信息",
            category="hardware",
            allowed_args=["-short", "-C", "-c", "-businfo"],
            risk_level="low",
            allowed_patterns=[r"-C\s+\w+", r"-c\s+\w+"],
        ),
        WhitelistedCommand(
            command="dmidecode",
            description="DMI信息",
        ...
        WhitelistedCommand(
            ...
            allowed_args=["-a", "-n"],
            risk_level="low",
            allowed_patterns=[r"-a", r"-n", r"net\.\S+", r"kernel\.\S+"],
        ),
        WhitelistedCommand(
            command="nmcli",
            ...
            category="network",
            allowed_args=[
                "device", "connection", "show", "status", "general",
                "-p", "-f", "-t",
            ],
            risk_level="low",
            allowed_patterns=[
        ...
        WhitelistedCommand(
            ...
            description="PCI配置空间",
            category="hardware",
            allowed_args=["-s", "-d", "-v", "-H"],
            risk_level="medium",
            allowed_patterns=[r"-s\s+[\da-fA-F:.]+", r"-d\s+[\da-fA-F:]+", r"VENDOR_ID", r"DEVICE_ID"],
        ),
        # VLAN 和网桥
        WhitelistedCommand(
            command="bridge",
            description="网桥管理",
            category="network",
            allowed_args=["link", "fdb", "mdb", "vlan"],
            risk_level="low",
        ),
        # 服务状态
        WhitelistedCommand(
            ...
            description="系统服务状态",
            category="service",
            allowed_args=["status", "is-active", "is-enabled", "show", "list-units"],
            risk_level="low",
            allowed_patterns=[
                r"status\s+\S+",
                r"show\s+\S+",
